...
向国外用户发送短信，只需要在手机号码前加上正确的国际区号即可，如美国和加拿大为 `+1`，当然前提是已在 [短信设置](/dashboard/messaging.html?appid={{appid}}#/message/sms/conf) 中选中了 **开启国际短信服务** （国际版应用无需设置此项）。中国区号为 `+86`，但可以省略。无区号的手机号码会默认使用中国区号。
