...
对于 Android 设备，LeanCloud SDK 会自动生成 uuid 作为 installationId 保存到云端。
...
_notificationChannel | 可选 | Android 8.0 以上设备在推送时需要传递 channnel id 才能正常接收推送，请参看 [Android 8.0 推送适配](./android_push_guide.html#hash-206781196)
