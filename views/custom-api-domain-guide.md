...
注意，绑定 API 域名后，即时通讯，Live Query 以及多人对战的 WebSocket 连接仍会使用共享域名。
...
没有商用版应用的用户如果需要协助备案或接入备案，请发送邮件至 support@leancloud.rocks 和我们联系。

协助备案或接入备案需要支付 600 元服务费（有商用版应用的用户此项服务免费）。